...
from addons.expression_addon.i18n.dictionary import dictionary
from addons.expression_addon.panels.AddonPanels import ExpressionProperties
...
def register():
    ...
    # 为场景添加一个自定义属性组
    bpy.types.Scene.expression_properties = bpy.props.PointerProperty(type=ExpressionProperties)
